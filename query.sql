...
SELECT * FROM tasks WHERE user_id = 16;
...
INSERT INTO tasks (title, description, status_id, user_id) VALUES ("Test", "Test2", 1, 1);
...
SELECT * FROM users WHERE email LIKE "ivansamoilenko@example.com";


-- Оновити ім'я користувача:

UPDATE users SET fullname = "Бакуменко Максим Дмитрович" WHERE id = 7;
